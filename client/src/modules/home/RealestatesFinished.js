...
class RealestatesFinished extends Component {
		...
		return (
			<div className='home' >
				<RealestatePublicSearchPanel
					...
					realEstateStatus={['FINISHED', 'FINISHED_SOLD']}
...
const hoc = connect(mapStateToProps, mapDispatchToProps)(RealestatesFinished);

export { hoc as RealestatesFinished };
