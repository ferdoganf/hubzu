...
class RealestatesOccasion extends Component {
...
const hoc = connect(mapStateToProps, mapDispatchToProps)(RealestatesOccasion);

export { hoc as RealestatesOccasion };
