...
export default class ContactUsForm extends Component {
    ...
    submit() {
        ...
        let inputList = [
            ...
            { field: 'message', label: I18n.t("label.MESSAGE") },
    ...
    render() {
        return (
            <div>
                ...
                <Captcha style={{ paddingTop: '10px' }} verifyCallback={this.verifyCallback} expiredCallback={this.expiredCallback} />
                <Button primary size="big" onClick={() => this.submit()}>
                    {I18n.t('button.SEND_MESSAGE')}
                </Button>
            </div>
        );
    }
