                ...
                <Menu.Menu position="right" style={{ fontSize: "0.8em" }}>
                    <Dropdown item text={I18n.t('menu.MY_ACCOUNT')}>
                        <Dropdown.Menu>
                            ...
                            <Dropdown.Item onClick={() => this.props.history.push('/bids')}>{I18n.t('menu.MY_BIDS')}</Dropdown.Item>
                            <Dropdown.Item onClick={() => this.props.history.push('/autobids')}>{I18n.t('menu.MY_AUTO_BIDS')}</Dropdown.Item>
